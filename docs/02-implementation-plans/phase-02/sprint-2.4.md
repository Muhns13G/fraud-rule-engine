...
- chosen profile strategy:
  - `default`: open local/validation-friendly mode
...
- keep validation usability balanced with stronger defaults
...
- Keep the implementation explanation-friendly for architecture discussion discussion.
