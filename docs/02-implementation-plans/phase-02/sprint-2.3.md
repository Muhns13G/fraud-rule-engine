...
- keep local validation usability in mind while tightening posture where reasonable
...
## Expected Output
- logs are more consistent and architecture discussion-ready
...
- Keep the project easy for a validation to run locally.
