...
## Scope
This sprint opens the next stage of rule governance by introducing constrained mutation workflows while hardening retrieval behavior for correctness and validation usability.
