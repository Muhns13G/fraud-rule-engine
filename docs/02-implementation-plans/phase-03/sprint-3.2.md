...
## Scope
This sprint matures profile-based security for governance operations while preserving local validation ergonomics.
...
- keep `default` profile intentionally open for local use
...
- security posture is more production-defensible while preserving local validation flow

## Notes
- keep local usability in `default` profile intentional and documented
