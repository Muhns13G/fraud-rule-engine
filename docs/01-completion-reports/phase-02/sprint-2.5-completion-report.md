...
| --- | --- | --- |
| `src/main/java/com/capitec/fraudengine/domain/model/RuleIdentity.java` | Created | Introduced governance identity model |
| `src/main/java/com/capitec/fraudengine/domain/model/RuleLifecycleState.java` | Created | Introduced lifecycle/activation state model |
| `src/main/java/com/capitec/fraudengine/domain/model/RuleGovernanceMetadata.java` | Created | Introduced governance metadata aggregate |
| `src/main/java/com/capitec/fraudengine/domain/model/enums/RuleLifecycleStatus.java` | Created | Added lifecycle status enum |
| `src/main/java/com/capitec/fraudengine/domain/model/enums/RuleActivationState.java` | Created | Added activation-state enum |
| `src/main/java/com/capitec/fraudengine/domain/model/enums/RuleExecutionSource.java` | Created | Added execution-source enum |
...
| `src/main/java/com/capitec/fraudengine/infrastructure/persistence/entity/RuleGovernanceMetadataEntity.java` | Created | JPA entity for governance metadata |
| `src/main/java/com/capitec/fraudengine/infrastructure/persistence/repository/RuleGovernanceMetadataJpaRepository.java` | Created/Modified | Added governance metadata repository queries |
| `src/main/java/com/capitec/fraudengine/infrastructure/persistence/mapper/RuleGovernanceMetadataPersistenceMapper.java` | Created | Mapper between domain governance and persistence |
| `src/main/java/com/capitec/fraudengine/application/service/RuleGovernanceMetadataBootstrapService.java` | Created/Modified | Startup upsert + policy enforcement for code-defined rules |
| `src/main/java/com/capitec/fraudengine/infrastructure/config/RuleGovernanceMetadataBootstrapConfiguration.java` | Created | Application runner wiring for governance bootstrap |
| `src/main/java/com/capitec/fraudengine/application/service/RuleGovernanceRetrievalService.java` | Created | Admin read service for governance metadata |
| `src/main/java/com/capitec/fraudengine/api/controller/RuleGovernanceController.java` | Created | Admin rule-governance read endpoints |
| `src/main/java/com/capitec/fraudengine/api/dto/RuleGovernanceMetadataResponseDto.java` | Created | API response shape for governed rules |
| `src/main/java/com/capitec/fraudengine/api/error/RuleGovernanceMetadataNotFoundException.java` | Created | Not-found exception for rule metadata identity |
| `src/main/java/com/capitec/fraudengine/api/error/GlobalExceptionHandler.java` | Modified | Added governance metadata not-found mapping |
| `src/main/java/com/capitec/fraudengine/common/error/InvalidRuleGovernanceStateException.java` | Created | Validation exception for invalid governance states |
| `src/main/java/com/capitec/fraudengine/domain/policy/RuleGovernancePolicy.java` | Created | Deterministic governance boundary policy |
| `src/test/java/com/capitec/fraudengine/api/controller/RuleGovernanceControllerIntegrationTest.java` | Created | Integration coverage for admin read APIs |
| `src/test/java/com/capitec/fraudengine/domain/policy/RuleGovernancePolicyTest.java` | Created | Unit coverage for lifecycle/activation boundary policy |
| `src/test/java/com/capitec/fraudengine/application/service/RuleGovernanceMetadataBootstrapServiceIntegrationTest.java` | Created | Integration coverage for bootstrap metadata seeding |
