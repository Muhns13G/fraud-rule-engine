...
import com.oitws.fraudengine.api.dto.RuleGovernanceHistoryPageResponseDto;
import com.oitws.fraudengine.api.dto.RuleGovernanceMetadataResponseDto;
import com.oitws.fraudengine.api.dto.RuleGovernanceMetadataPageResponseDto;
import com.oitws.fraudengine.api.dto.RuleGovernanceStateTransitionRequestDto;
import com.oitws.fraudengine.api.dto.RuleGovernanceVersionRegistrationRequestDto;
import com.oitws.fraudengine.api.dto.RuleGovernanceWorkflowActionRequestDto;
import com.oitws.fraudengine.api.error.RuleGovernanceMetadataNotFoundException;
import com.oitws.fraudengine.application.service.RuleGovernanceMutationService;
import com.oitws.fraudengine.application.service.RuleGovernanceRetrievalService;
...
public class RuleGovernanceController {
	...
	@ApiResponses({
		...
		@ApiResponse(
			...
			content = @Content(schema = @Schema(implementation = com.oitws.fraudengine.api.error.ApiErrorResponse.class))
		)
	})
